...
<div class="alert alert-primary collapse {{ empty($hide) ? 'show' : '' }}" role="alert" id="instrucoes">
  ...
  @else
    <br />
    A matrícula somente poderá ser realizada pelos candidatos aprovados{{ $matricula->selecao->exigeCategoria() ? ($matricula->selecao->exigePrograma() ? ' no processo seletivo' : ' pelo(a)(s) ministrante(s) da(s) disciplina(s)') : '' }}.
    <br />
