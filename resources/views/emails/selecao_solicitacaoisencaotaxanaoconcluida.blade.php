...
<br />
O período de solicitações de isenção de taxa {{ str_starts_with($objetivo, 'aluno especial') ? 'para ' . $objetivo : 'de ' . $objetivo }} encerra-se em {{ formatarDataHora($selecao->solicitacoesisencaotaxa_datahora_fim) }}.<br />
